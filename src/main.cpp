...
hardware::drivers::CSteeringMotor g_cSteeringDriver(D8);
...
brain::CRobotStateMachine           g_robotstatemachine(g_period_Encoder, g_rpi, g_motorVnhDriver,g_steeringDriver, g_cSteeringDriver,&g_controller);
